...
circularMeterR([&]() { return audioProcessor.getRmsLevel(1); }, Colours::cyan)
{
    ...
    leftSlider.setColour(Slider::ColourIds::rotarySliderFillColourId,
                         Colours::violet.withBrightness(0.6f));
    ...
    rightSlider.setColour(Slider::ColourIds::rotarySliderFillColourId,
                          Colours::cyan.withBrightness(0.6f));
